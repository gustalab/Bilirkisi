...
library(formattable)
  ...
  dosya_bilgiler <- read_excel("../Aktüeryal_Bilirkisi_Projesi/data/dosya_bilgiler.xlsx", sheet = "Sayfa1")
  
  PR_TRH_2010 <- read_excel("../Aktüeryal_Bilirkisi_Projesi/data/TRH2010_son.xlsx", sheet = "Sayfa1")
  
  Asgari_Tablo <- read_excel("../Aktüeryal_Bilirkisi_Projesi/data/Asgari Ucret Tablosu.xlsx", sheet = "Program")
