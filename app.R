...
kaza_tarihi <- as.Date("2022-01-01")

input_data <- data.frame(Brand = seq(from = kaza_tarihi , to = Sys.Date(), by = "year"),
                         Gelir = 0,
                                          ...
                                          dropdownButton(label = "Çocuk Doğum Tarihi",
                                                         ...
                                                         div( id = "11",
                                                              wellPanel(
                                                                ...
                                                                dateInput("cocukdogumtarihi1", label = NULL)
                                          ...
                                          dropdownButton(label = "Çocukların Doğum Tarihleri",
                                                         ...
                                                         div( id = "55",
                                                              ...
                                                              wellPanel(
                                                                ...
                                                                dateInput("cocukdogumtarihi554", label = NULL)
                                ...
                                wellPanel(
                                  ...
                                  div(
                                    ...
                                    conditionalPanel(
                                      ...
                                      p(tags$b("Bakıcı Gideri Başlangıç Tarihi")),
                                      dateInput("dogumtarihi", label = NULL),
                                      br(),
                                      p(tags$b("Bakıcı Gideri Bitiş Tarihi")),
                                      dateInput("kazatarihi", label = NULL),
                                      br(),
                                    )
                        ...
                        div(
                          column(
                            ...
                            radioGroupButtons(
                              inputId = "rapor",
                              label = "Rapor Seç",
                              choices = c("Tüm Rapor", "Geçici", "Geçici + Sürekli"),
                              justified = TRUE,
                              direction = "vertical",
                              status = "danger",
                              checkIcon = list(
